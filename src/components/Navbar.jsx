    ...
    return (
        ...
        >
            ...
            <span className={`absolute bottom-0 left-0 w-0 h-0.5 transition-all duration-300 ease-out group-hover:w-full ${
                isScrolled ? 'bg-blue-400 hover:font-bold' : 'bg-white'
            }`}></span>
        </a>
    );
};
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0 flex items-center gap-2">
                        ...
                        <img src={isScrolled ? logo : white_logo} alt='Tourain logo' className='w-36 h-7 cursor-pointer'/>
            ...
            {isOpen && (
                <div className="md:hidden bg-white/95 backdrop-blur-md absolute top-full left-0 w-full shadow-lg border-b border-gray-100">
                    <div className="px-4 pt-2 pb-6 space-y-2">
                        <a href="#why" className="block px-3 py-2 text-gray-800 hover:bg-gray-50 hover:text-bold rounded-md font-medium">Why Tourain</a>
